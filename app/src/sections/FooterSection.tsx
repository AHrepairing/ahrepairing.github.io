      ...
      <div className="border-b border-white/10">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div>
              <img src="/logo.png" alt="AH Repairing" className="h-14 w-auto" />
            </div>
            <div className="flex items-center gap-4 w-full lg:w-auto">
              ...
              <form onSubmit={handleSubscribe} className="flex gap-3 w-full lg:w-auto">
                <input
                  ...
                  className="flex-1 lg:w-64 bg-white rounded-lg px-4 py-3 text-sm text-gray-800 placeholder-gray-400 outline-none focus:ring-2 focus:ring-orange-500"
                  required
                />
                <button
                  type="submit"
                  className="bg-orange-500 text-white px-6 py-3 rounded-lg text-sm font-semibold transition-all duration-300 hover:bg-orange-600 whitespace-nowrap"
                >
                  {t('footer.subscribe')}
                </button>
              </form>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-5">
              ...
              <a href="#" aria-label="Facebook" className="text-white/50 hover:text-orange-500 transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </a>
              <a href="#" aria-label="Instagram" className="text-white/50 hover:text-orange-500 transition-colors">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div>
            ...
            <a
              ...
              className="block text-2xl font-bold text-white hover:text-orange-500 transition-colors mb-5"
            >
              +966541638686
            </a>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-orange-500 text-white px-6 py-3 rounded-lg text-sm font-semibold transition-all duration-300 hover:bg-orange-600"
            >
